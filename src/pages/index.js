		...
		<Section padding="64px 0" sm-padding="40px 0" font="--base" color="--dark">
			...
			<Stack margin-top="40px">
				<StackItem width="25%" lg-width="50%" sm-width="100%">
					<Override slot="StackItemContent" flex-direction="column" />
					<Box height="0" margin="0 0 20px 0" padding-bottom="100%" background="url(https://uploads.quarkly.io/5faad99e79530b001fd24b49/images/1%20(1).png?v=2020-11-10T19:02:39.517Z) 50% 0/cover no-repeat" />
